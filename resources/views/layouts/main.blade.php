<!DOCTYPE html>
<html lang="en" data-footer="true" data-override='{"attributes": {"placement": "vertical", "layout": "fluid","radius": "standard", "color": "light-purple"}, "showSettings":false}'>
...
<style>
    .overlay-spinner {
        ...
        width: 100%;
        height: 100%;
        background-color: rgba(124, 124, 124, 0.19);
        z-index: 1000;
        display: flex;
        align-items: center;
...
<body>
    <div id="root">
        ...
        @yield('main');
        <!-- Layout Footer Start -->
        @if (Request::segment(2) != 'penjualan')
    ...
    <script src="/vendor/acorn/js/vendor/autoComplete.min.js"></script>
    <script src="/vendor/acorn/js/vendor/clamp.min.js"></script>
    ...
    <script src="/vendor/acorn/icon/acorn-icons-learning.js"></script>
    <script src="/vendor/acorn/icon/acorn-icons-medical.js"></script>
    <script src="/vendor/acorn/js/vendor/Chart.bundle.min.js"></script>
    <script src="/vendor/acorn/js/vendor/chartjs-plugin-datalabels.js"></script>
    <script src="/vendor/acorn/js/vendor/chartjs-plugin-rounded-bar.min.js"></script>
    <script src="/vendor/acorn/js/vendor/glide.min.js"></script>
    <script src="/vendor/acorn/js/vendor/intro.min.js"></script>
    <script src="/vendor/acorn/js/vendor/select2.full.min.js"></script>
    <script src="/vendor/acorn/js/vendor/plyr.min.js"></script>
    <script src="/vendor/acorn/js/vendor/datatables.min.js"></script>
    <script src="/vendor/acorn/js/vendor/imask.js"></script>
    <script src="/vendor/acorn/js/vendor/datepicker/bootstrap-datepicker.min.js"></script>
    <script src="/vendor/acorn/js/vendor/datepicker/locales/bootstrap-datepicker.es.min.js"></script>
    <!-- Vendor Scripts End -->
    ...
    <script src="/vendor/acorn/js/base/search.js"></script>
    <script src="/vendor/acorn/js/base/settings.js"></script>
    <script src="/vendor/acorn/js/vendor/Chart.bundle.min.js"></script>
    <script src="/vendor/acorn/js/vendor/chartjs-plugin-rounded-bar.min.js"></script>
    <script src="/vendor/acorn/js/vendor/chartjs-plugin-crosshair.js"></script>
    <script src="/vendor/acorn/js/vendor/chartjs-plugin-datalabels.js"></script>
    <script src="/vendor/acorn/js/vendor/chartjs-plugin-streaming.min.js"></script>
    ...
    <script src="/vendor/acorn/js/vendor/jquery.validate/jquery.validate.min.js"></script>
    <script src="/vendor/acorn/js/vendor/jquery.validate/additional-methods.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <script src="/vendor/acorn/js/cs/datatable.extend.js"></script>
    <script src="/vendor/acorn/js/plugins/datatable.boxedvariations.js"></script>
    <script src="/vendor/acorn/js/cs/glide.custom.js"></script>
    <script src="/vendor/acorn/js/cs/charts.extend.js"></script>
    <script src="/vendor/acorn/js/plugins/charts.js"></script>
    {{-- <script src="/vendor/acorn/js/pages/dashboard.default.js"></script> --}}
    <script src="/vendor/acorn/js/forms/controls.select2.js"></script>
    <script src="/vendor/acorn/js/forms/controls.datepicker.js"></script>
