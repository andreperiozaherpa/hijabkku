...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('manajemen_user.user', ['toko' => $toko, 'roles' => $roles]);
    }
    ...
    public function rbacRoleStore(Request $request)
    {
        $validator = \Validator::make($request->all(), [
            ...
            'name.regex' => 'Format Nama Role tidak valid (hanya huruf, angka, - dan _).',
